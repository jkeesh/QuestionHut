...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.last_visited'
        db.add_column('qa_userprofile', 'last_visited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 11, 10, 18, 12, 42, 715002), auto_now=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.last_visited'
        db.delete_column('qa_userprofile', 'last_visited')
    ...
    models = {
        ...
        'qa.userprofile': {
            ...
            'last_visited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 10, 18, 12, 42, 715002)', 'auto_now': 'True', 'blank': 'True'}),
