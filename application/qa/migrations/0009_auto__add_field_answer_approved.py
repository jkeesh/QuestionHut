...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Answer.approved'
        db.add_column('qa_answer', 'approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Answer.approved'
        db.delete_column('qa_answer', 'approved')
    ...
    models = {
        ...
        'qa.userprofile': {
            ...
            'courses': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['qa.Course']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
