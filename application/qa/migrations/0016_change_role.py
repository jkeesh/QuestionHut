...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('qa_userprofile_courses', 'userprofile_id', 'profile_id')
        db.rename_column('qa_userprofile_courses', 'course_id', 'hut_id')
        
        db.add_column('qa_userprofile_courses', 'level', models.IntegerField(default=1))

        db.rename_table('qa_userprofile_courses', 'qa_role')
