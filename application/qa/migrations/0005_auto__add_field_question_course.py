...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('qa_question', 'course', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['qa.Course'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Question.course'
        db.delete_column('qa_question', 'course_id')
