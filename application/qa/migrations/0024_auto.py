...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field followers on 'Question'
        db.create_table('qa_question_followers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm['qa.question'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('qa_question_followers', ['question_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field followers on 'Question'
        db.delete_table('qa_question_followers')
    ...
    models = {
        ...
        'qa.question': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'followers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'questions_followed'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'qa.userprofile': {
            ...
            'last_visited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 8, 1, 20, 2, 770932)', 'auto_now': 'True', 'blank': 'True'}),
