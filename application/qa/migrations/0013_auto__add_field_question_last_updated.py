...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('qa_question', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 10, 6), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Question.last_updated'
        db.delete_column('qa_question', 'last_updated')
