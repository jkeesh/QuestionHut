...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('qa_userprofile', 'points', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.points'
        db.delete_column('qa_userprofile', 'points')
