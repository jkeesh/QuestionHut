...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('qa_question', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'Question.last_updated'
        db.alter_column('qa_question', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
