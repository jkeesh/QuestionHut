...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.points'
        db.alter_column('qa_userprofile', 'points', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'UserProfile.points'
        db.alter_column('qa_userprofile', 'points', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        'qa.userprofile': {
            ...
            'last_visited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 31, 1, 13, 36, 530401)', 'auto_now': 'True', 'blank': 'True'}),
