...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Role.subscribed'
        db.add_column('qa_role', 'subscribed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Role.subscribed'
        db.delete_column('qa_role', 'subscribed')
    ...
    models = {
        ...
        'qa.userprofile': {
            ...
            'last_visited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 12, 0, 36, 30, 850661)', 'auto_now': 'True', 'blank': 'True'}),
