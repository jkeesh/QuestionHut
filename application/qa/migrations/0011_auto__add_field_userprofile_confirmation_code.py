...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('qa_userprofile', 'confirmation_code', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.confirmation_code'
        db.delete_column('qa_userprofile', 'confirmation_code')
