...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field moderator_courses on 'UserProfile'
        db.create_table('qa_userprofile_moderator_courses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['qa.userprofile'], null=False)),
            ('course', models.ForeignKey(orm['qa.course'], null=False))
        ))
        db.create_unique('qa_userprofile_moderator_courses', ['userprofile_id', 'course_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field moderator_courses on 'UserProfile'
        db.delete_table('qa_userprofile_moderator_courses')
    ...
    models = {
        ...
        'qa.userprofile': {
            ...
            'courses': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'students'", 'symmetrical': 'False', 'to': "orm['qa.Course']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
